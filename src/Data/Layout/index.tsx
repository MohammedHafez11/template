...
export const userMessageData = [
  { status: "active", name: "محمد حافظ ", message: "Are you there ?" },
  { name: "محمد حافظ", message: "Are you there ?" },
  { status: "offline", name: "محمد حافظ ", message: "hello ! how are you ?" },
];
...
export const smallSideBarData: SideBarDataInterFace[] = [
  { title: "الاخبار", icon: "File" },
  { title: "الموسيقي & الفيديو", icon: "Headphones" },
  { title: "الطقس", icon: "Cloud" },
  { title: "التاريخ", icon: "Calendar" },
];
...
export const otherPagesData = [
  ...
  { diffrentImage: "messanger", title: "المراسلات", navigate: "/messanger" },
  { diffrentImage: "setting", title: "الاعدادات", navigate: "/settings" },
  { diffrentImage: "help", title: "مساعده", navigate: "/helparticle" },
];
...
export const closeFriendsData = [
  { id: 1, name: "محمد حافظ ", image: "1", message: ["demo1"] },
  { id: 2, name: "محمد حافظ ", image: "2", message: ["demo2"] },
];

export const recentChatsData = [
  { id: 3, name: "محمد حافظ ", image: "3", message: ["demo1"] },
  { id: 4, name: "محمد حافظ ", image: "4", message: ["demo2"] },
  { id: 5, name: "محمد حافظ ", image: "5", message: ["demo2"] },
  { id: 6, name: "محمد حافظ ", image: "6", message: ["demo2"] },
  { id: 7, name: "محمد حافظ ", image: "7", message: ["demo2"] },
];
